...
Khi nào là tích của các số nguyên tố khác nhau thì $\left|\mathbb{Z}_N^*\right|$ thỏa mãn $\left|\mathbb{Z}_N^*\right|=\left|\mathbb{Z}_p^*\right| \cdot\left|\mathbb{Z}_{q}^*\right| \cdot\left|\mathbb{Z}_r^*\right|=(p-1)(q-1)(r-1)$
